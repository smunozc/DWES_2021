...
public class RestClient2 {
	...
	public static void addDriver(Driver driver) {
		...
		try {
			...
			WebTarget webTarget = client.target("http://localhost:9096/SMunozPT2RRestServer/apirest/driver/add-driver");

			Invocation.Builder invocationBuilder = webTarget.request(MediaType.APPLICATION_JSON);

			Response response = invocationBuilder.build("POST", Entity.entity(driver, MediaType.APPLICATION_JSON))
