...
<html>
	...
	<body>
		<div class="container">
		  <h2>Create new book - PUT method (be aware: it's an idempotent action!)</h2>
	    ...
	    <button type="submit" class="btn btn-primary" id="submit-button" disabled>Create new book</button>
  </form>
</div>
