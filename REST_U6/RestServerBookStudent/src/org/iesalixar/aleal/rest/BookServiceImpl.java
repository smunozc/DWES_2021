...
public class BookServiceImpl implements BookService {
	...
	@Produces(MediaType.APPLICATION_JSON)
	@Override
	public Response getBookByIsbnAndYear(
			@PathParam("isbn") int bookIsbn,
	...
	public Response getAllBooks() {
		...
		try {
			...
			logger.error("'BookServiceImpl.getAllBooks - operation GET' method has raised an exception: " + e.getMessage());
		}
	...
	public Response addBook(Book book) {
		...
		try {
			...
			logger.error("'BookServiceImpl.addBook - operation POST' method has raised an exception: " + e.getMessage());
	...
	public Response fullModifyBook(Book book) {
		...
		try {
			...
			logger.error("'BookServiceImpl.fullModifyBook - operation PUT' method has raised an exception: " + e.getMessage());
			Response.serverError().build();
		}
	...
	public Response partialModifyBook(Book book) {
		...
		try {
			...
			jsonObject.put("patch-book-id",String.valueOf(book.getId()));
			logger.info("REST web service 'BookServiceImpl.partialModifyBook - operation PATCH' method has been invoked.");
		} catch (Exception e) {
			logger.error("'BookServiceImpl.partialModifyBook - operation PATCH' method has raised an exception: " + e.getMessage());
			Response.serverError().build();
		}
	...
	public Response removeBook(Book book) {
		...
		try {
			...
			logger.error("'BookServiceImpl.removeBook - operation DELETE - book' method has raised an exception: " + e.getMessage());
			Response.serverError().build();
	...
	private String bookByIsbnAndYear(int bookIsbn, int year) {
		...
		try {
			...
			logger.error("'BookServiceImpl.bookByIsbnAndYear' private method has raised an exception: " + e.getMessage());
		}
		return jsonBook.toString();
	}
