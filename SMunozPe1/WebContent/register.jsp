	...
	<main>
		<form class="frm" action="register" method="post">
			<label for="username">Username:</label> <input type="text"
				name="username" class="username"><span class="status"></span>
			<label for="password">Password:</label> <input type="password"
				name="password"> <label for="fullname">Full name:</label> <input
				type="text" name="fullname"> <label for="email">Email:</label>
			<input type="text" name="email"> <input
				class="btn submitButton" type="submit" value="Register">
		</form>
	</main>
	<footer>
