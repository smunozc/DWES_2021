...
public class DeleteBookParametersServlet extends HttpServlet {
	...
	final static Logger logger = Logger.getLogger(DeleteBookParametersServlet.class);
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {			
			...
			String result = bookStudentClient.deleteBookStudent(book);
